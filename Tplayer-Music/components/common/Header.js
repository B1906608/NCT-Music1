      ...
      <div className={cls(styles.header)}>
        ...
        <div className={cls(styles.links)}>
          ...
          <div className={(styles.links_avatar)}>
            ...
            alt="hello"
          />
            <div className={cls(styles.avatar_acc)}>
              <ul id="account" className={cls(styles.avatar_acc_ul)}>
                <Link href={"/login"}>
                  <li className={cls(styles.acc_login)}>
                    Đăng nhập</li>
                </Link>
                <Link href={"/resigter"}>
                  <li className={cls(styles.acc_resigter)}>
                    Đăng ký</li>
                </Link>
              </ul>
            </div>
